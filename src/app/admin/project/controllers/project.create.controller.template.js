(function(angular) {
	...
	angular.module('spmiFrontEnd')
		.controller('CreateTemplateProjectController', CreateTemplateProjectController)
		
	function CreateTemplateProjectController($rootScope, $scope, $state, $modal, $window, $timeout, ProjectConverterService, ProjectTemplateService) {
		var vm = this;
		...
		vm.checkpoint = function() {
			...
			if ($scope.ProjectForm.$valid) {
				ProjectTemplateService.store(vm.input).then(function() {
